...
const custom = async (imageUrl, bott, top = '') => new Promise((resolve, reject) => {
	bottText = bott.replace(/ /g, '%20').replace('\n','%5Cn')
    fetchBase64(`https://api.memegen.link/images/custom/${top}/${bottText}.png?background=${imageUrl}`, 'image/png')
